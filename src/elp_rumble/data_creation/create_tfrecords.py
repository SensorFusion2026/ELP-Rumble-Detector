...
def main():
    ...
    inputs = [
        {"folder": POS_TRAIN_VAL_CLIPS_DIR, "label": 1, "split": "train"},
        {"folder": TRAIN_VAL_NEG_CLIPS_DIR, "label": 0, "split": "train"},
        {"folder": POS_HOLDOUT_TEST_CLIPS_DIR, "label": 1, "split": "test"},
        {"folder": HOLDOUT_TEST_NEG_CLIPS_DIR, "label": 0, "split": "test"},
    ]
